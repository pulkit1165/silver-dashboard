...
export default function LabelDesigner() {
  ...
  const loadSku = async () => {
    ...
    try {
      ...
      setFill({ sku_code: l.sku_code, name: l.name, price: l.price, unit: l.unit || "PCS", singleQty: l.singleQty ?? 1, masterQty: l.masterQty ?? 1, lot: l.lot, rack: l.rack, pkd: l.pkd, qrSvg: l.qrSvgSingle || l.qrSvg, address: fill.address });
