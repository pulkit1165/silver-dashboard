    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { href: "/erp/masters/item-net-rate", label: "Item-wise Net Rate", icon: "₹", roles: ["admin", "sales", "accounts"] },
          { href: "/erp/masters/foc", label: "FOC Disc%", icon: "🎁", roles: ["admin", "sales", "accounts"] },
